...
import com.example.douban.di.component.DaggerPlayerComponent;
...
public class PlayerActivity extends BaseActivity<PlayerPresenter> implements PlayerContract.View {
    ...
    @Override
    public void initPlayer(DetailBean.TrailersBean trailersBean) {
        List<DetailBean.TrailersBean> list = new ArrayList<>();
        list.add(trailersBean);
        videoPlayer.setUp(list, false, "测试标题");
        //增加title
